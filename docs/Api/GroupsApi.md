...
# **createGroup**
> \ProcessMaker\Client\Model\Groups createGroup($groups_editable)
...
$apiInstance = new ProcessMaker\Client\Api\GroupsApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$groups_editable = new \ProcessMaker\Client\Model\GroupsEditable(); // \ProcessMaker\Client\Model\GroupsEditable | 
...
------------- | ------------- | ------------- | -------------
 **groups_editable** | [**\ProcessMaker\Client\Model\GroupsEditable**](../Model/GroupsEditable.md)|  |
...
# **deleteGroup**
> \ProcessMaker\Client\Model\Groups deleteGroup($group_id)
...
# **getGroupById**
> \ProcessMaker\Client\Model\Groups getGroupById($group_id)
...
# **getGroups**
> \ProcessMaker\Client\Model\InlineResponse2005 getGroups($filter, $order_by, $order_direction, $per_page, $include)
...
[**\ProcessMaker\Client\Model\InlineResponse2005**](../Model/InlineResponse2005.md)
...
# **updateGroup**
> \ProcessMaker\Client\Model\Groups updateGroup($group_id, $groups_editable)
