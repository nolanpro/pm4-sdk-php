...
class GroupUsersApi
{
     ...
     * @return \ProcessMaker\Client\Model\InlineResponse2006
     */
     ...
     * @throws \ProcessMaker\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ProcessMaker\Client\Model\InlineResponse2006, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMembersWithHttpInfo($filter = null, $order_by = null, $order_direction = 'asc', $per_page = 10, $include = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ProcessMaker\Client\Model\InlineResponse2006' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ProcessMaker\Client\Model\InlineResponse2006', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ProcessMaker\Client\Model\InlineResponse2006';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ProcessMaker\Client\Model\InlineResponse2006',
