...
class Users implements ModelInterface, ArrayAccess
{
     ...
     * Sets id
     *
     * @param string|null $id The attributes that are mass assignable.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The attributes that are mass assignable.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at The attributes that are mass assignable.
     *
     * @return $this
     */
